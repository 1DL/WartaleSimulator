...
import controller.game.item.acessory.ItemAmulet;
import controller.game.item.acessory.ItemRing;
import controller.game.item.acessory.ItemSheltom;
import controller.game.item.defense.ItemArmor;
import controller.game.item.defense.ItemBoots;
import controller.game.item.defense.ItemBracelets;
import controller.game.item.defense.ItemGauntlets;
import controller.game.item.defense.ItemOrb;
import controller.game.item.defense.ItemRobe;
import controller.game.item.defense.ItemShield;
import controller.game.item.weapon.ItemAxe;
import controller.game.item.weapon.ItemBow;
import controller.game.item.weapon.ItemClaw;
import controller.game.item.weapon.ItemDagger;
import controller.game.item.weapon.ItemHammer;
import controller.game.item.weapon.ItemJavelin;
import controller.game.item.weapon.ItemPhantom;
import controller.game.item.weapon.ItemScythe;
import controller.game.item.weapon.ItemSword;
import controller.game.item.weapon.ItemWand;
